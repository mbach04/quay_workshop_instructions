...
## If you having an existing Openshift 4 Cluster

If you are running an existing Openshift 4 cluster. Please navigate to the "Operators" tab under the Administrator's view. 
